...
namespace AddUp.CommonLogging.Simple
{
    ...
    ///   &lt;common&gt;
    ///     &lt;logging&gt;
    ///       &lt;factoryAdapter type=&quot;AddUp.CommonLogging.Simple.TraceLoggerFactoryAdapter, AddUp.CommonLogging&quot;&gt;
    ...
    public class TraceLoggerFactoryAdapter : AbstractSimpleLoggerFactoryAdapter
    {
        ...
        public TraceLoggerFactoryAdapter(NameValueCollection properties) : base(properties) =>
            UseTraceSource = ArgUtils.TryParse(false, properties["useTraceSource"]);
        ...
        public TraceLoggerFactoryAdapter(LogLevel level, bool showDateTime, bool showLogName, bool showLevel, string dateTimeFormat, bool useTraceSource)
            : base(level, showDateTime, showLogName, showLevel, dateTimeFormat) => UseTraceSource = useTraceSource;

        /// <summary>
        /// Whether to use <see cref="Trace"/>.<c>TraceXXXX(string,object[])</c> methods for logging
        /// or <see cref="TraceSource"/>.
        /// </summary>
        public bool UseTraceSource { get; }

        /// <summary>
        /// Creates a new <see cref="TraceLogger"/> instance.
        /// </summary>
        protected override ILog CreateLogger(string name, LogLevel level, bool showLevel, bool showDateTime, bool showLogName, string dateTimeFormat) =>
            new TraceLogger(UseTraceSource, name, level, showLevel, showDateTime, showLogName, dateTimeFormat);
    }
}
