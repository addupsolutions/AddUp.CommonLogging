...
namespace AddUp.CommonLogging.Configuration
{
    ...
    public class ArgUtilsTests
    {
        ...
        public void Coalesce()
        {
            ...
            Assert.AreEqual(string.Empty, ArgUtils.Coalesce((Predicate<string>)null, string.Empty, null, "x"));
            Assert.AreEqual(null, ArgUtils.Coalesce<object>(v => v != null));
            Assert.AreEqual(string.Empty, ArgUtils.Coalesce<object>(v => v != null, null, string.Empty, "x"));
        }
        ...
        public void Guard()
        {
            ...
            Assert.AreEqual(1, ArgUtils.Guard(() => 1, "format {0}", "fmtarg"));
