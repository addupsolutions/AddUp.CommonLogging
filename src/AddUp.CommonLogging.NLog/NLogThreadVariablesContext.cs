...
namespace AddUp.CommonLogging.NLog
{
    ...
    public sealed class NLogThreadVariablesContext : IVariablesContext
    {
        ...
        public void Set(string key, object value) => ContextNLog.Set(key, value?.ToString());
        ...
        public object Get(string key) => ContextNLog.Get(key);
        ...
        public bool Contains(string key) => ContextNLog.Contains(key);

        /// <summary>
        /// Removes a variable from the global context by key
        /// </summary>
        /// <param name="key">The key of the variable to remove</param>
        public void Remove(string key) => ContextNLog.Remove(key);

        /// <summary>
        /// Clears the global context variables
        /// </summary>
        public void Clear() => ContextNLog.Clear();
    }
}